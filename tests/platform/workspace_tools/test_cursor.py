"""
Platform workspace tools tests for Cursor agent.
...
Run:
    pytest tests/platform/workspace_tools/test_cursor.py -v
"""
...
class TestCursorWorkspaceTools:
    """Test workspace tool availability for Cursor."""
...
class TestCursorWorkspaceToolsReport:
