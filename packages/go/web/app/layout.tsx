...
export default function RootLayout({
  ...
  // Font variables go on <html> rather than <body> so portalled content —
  // Radix popovers, the Sonner toaster — resolves them too.
  return (
    <html
      lang="en"
    ...
    >
      ...
      <body className="font-sans bg-zinc-100 dark:bg-zinc-900">
