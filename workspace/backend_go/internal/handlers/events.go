...
import (
	...
	"github.com/woowonjae1/52hzAgents/workspace/backend_go/internal/hub"    // 自研的内存级多路复用广播 Hub。
	"github.com/woowonjae1/52hzAgents/workspace/backend_go/internal/models" // 表结构模型映射定义。
)
