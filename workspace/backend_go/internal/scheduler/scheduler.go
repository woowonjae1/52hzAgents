...
import (
	...
	"github.com/woowonjae1/52hzAgents/workspace/backend_go/internal/handlers" // 引入 ComputeNextFiresAt 算法。
	"github.com/woowonjae1/52hzAgents/workspace/backend_go/internal/hub"    // 内存广播 Hub。
	"github.com/woowonjae1/52hzAgents/workspace/backend_go/internal/models" // 表模型结构体。
)
